<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddKyLuat.aspx.cs" Inherits="BaiTapLon_QlyNhanSu.AddKyLuat" %>
        ...
        <div>
            ...
            <div class="bo2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="IDChucVu" HeaderText="Mã nhân viên"></asp:BoundField>
                        <asp:BoundField DataField="TenChucVu" HeaderText="Họ tên"></asp:BoundField>
                        <asp:BoundField DataField="TenChucVu" HeaderText="Lý do"></asp:BoundField>
