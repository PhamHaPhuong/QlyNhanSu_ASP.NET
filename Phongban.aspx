<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="BaiTapLon_QlyNhanSu.WebForm3" %>
        ...
        <div class="dad">
            <div class="son1">
                ...
                <div class="nav">
                    ...
                    <div class="chon"><a href="Phongban.aspx"><i class="fas fa-building"></i>Phòng ban</a></div>
            ...
            <div class="son2">
                ...
                <div class="content">
                    <div class="form">
                        <div class="thaotac"><h2>Danh sách phòng ban </h2></div>
                        <div class="thaotac" style="float:right;">
                            <asp:Button ID="them" runat="server" Text="Thêm phòng ban " OnClick="them_Click" />
                        </div>
