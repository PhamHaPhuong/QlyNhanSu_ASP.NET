<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chucvu.aspx.cs" Inherits="BaiTapLon_QlyNhanSu.WebForm4" %>
        ...
        <div class="dad">
            <div class="son1">
                ...
                <div class="nav">
                    ...
                    <div class="chon"><a href="Chucvu.aspx"><i class="fas fa-briefcase"></i>Chức vụ</a></div>
            ...
            <div class="son2">
                ...
                <div class="content">
                    <div class="form">
                        <div class="thaotac"><h2>Danh sách chức vụ</h2></div>
                        <div class="thaotac" style="float:right;">
                            <asp:Button ID="them" runat="server" Text="Thêm chức vụ" OnClick="them_Click" />
                        </div>
                        ...
                        <div class="table">
                            ...
                            <div class="bang">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField DataField="IDChucVu" HeaderText="Mã chức vụ"></asp:BoundField>
                                        <asp:BoundField DataField="TenChucVu" HeaderText="Tên chứ vụ"></asp:BoundField>
